...
class Agent:
    ...
    def apply_poi_effect(self, poi_effects: Dict[str, float]) -> None:
        ...
        self._apply_effect_with_diminishing_returns("weapon_strength", poi_effects.get("weapon_strength", 0), 
                                                   self._skill_caps["weapon_strength"])
        self._apply_effect_with_diminishing_returns("management_skill", poi_effects.get("management_skill", 0),
