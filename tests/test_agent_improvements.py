...
def test_agent_skill_caps():
    ...
    assert captain._skill_caps["weapon_strength"] > sergeant._skill_caps["weapon_strength"]
    assert sergeant._skill_caps["weapon_strength"] > private._skill_caps["weapon_strength"]
